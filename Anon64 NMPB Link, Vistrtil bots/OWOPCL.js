...
function Client(uri, socketParams = null) {
...
Client.prototype.isConnecting = function() {
	return (
		this.isSupported() && this.ws && this.ws.readyState === WebSocket.CONNECTING
	);
};
...
Client.prototype.connect = function() {
	...
	if (typeof module !== 'undefined') {
		...
		if (this.socketEnabled) {
			this.agent = new HttpsProxyAgent(url.parse(this.socketParams.socketIp));
		}
