...
var selfName = "ＡＴＬＡＳ Ａ.Ｉ";							//your name
...
if (typeof(done) === "undefined") {
        ...
        function updateName(name) {
         ...
         /*var nameschar = ["❄️ＡＴＬＡＳ Ａ.Ｉ","ＨＡＰＰＹ","🎄ＨＯＬＩＤＡＹＳ🎄","ＦＲＯＭ","☃️ＡＴＬＡＳ","❄️ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ❄️","☃️ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ☃️","❄️ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ❄️","☃️ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ☃️","❄️ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ❄️","☃️ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ☃️","❄️ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ❄️","🎄ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ🎄","❄️ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ❄️","☃️ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ☃️","🎄ＡＴＬＡＳ Ａ.Ｉ|ＣＨＲＩＳＴＭＡＳ🎄","Ａ","ＡＴ","ＡＴＬ","ＡＴＬＡ","🎄ＡＴＬＡＳ🎄"]; // put the names to cycle through, here
   */
   ...
   $(".relative").append('<div id="toggle-btn" class="ugly-button toggle-btn" style="position: fixed;bottom: 500px;right:295px;width: 90px;color: red;colo"r: blue;">NameChange</div>'); //ugle = text button|ugly = looks like a button //class="toggle-btn" = text|class="ugly-button toggle-btn" = button
        $("#toggle-btn").click(function() {
            if (toggle) {
                ...
                MPP.chat.send("BrinBoat is loading... Powered by ＡＴＬＡＳ Ａ.Ｉ v4.0.");
